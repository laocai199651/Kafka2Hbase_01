...
import com.cwk.disruptor.handler.HandlerBranch1;
import com.cwk.disruptor.handler.HandlerBranch2;
import com.cwk.disruptor.handler.HandlerBranch3;
import com.cwk.disruptor.handler.HandlerBranch4;
...
public class MainRhombusHandle {
    public static void main(String[] args) throws InterruptedException {
        ...
        }, bufferSize, Executors.defaultThreadFactory()/*executor*/, ProducerType.SINGLE, new BusySpinWaitStrategy());
